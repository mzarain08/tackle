...
<div class="fs-lg text-600 mb-2"><?php echo __("Who Likes Me","premiumpress"); ?></div>

<p class="mb-4"><?php echo __("Here you can see whos has liked your ads.","premiumpress") ?></p>
...
<?php }else{ ?>
  ...
  <div class="card-body">
   ...
   <p class="opacity-8 text-600"><?php echo str_replace("%s", do_shortcode("[HITS pid=".$id."]") ,__("%s total views","premiumpress")); ?></p>
<hr />


  <?php 
  
	  $f = get_post_meta($id, 'new_likes_array', true);
...
<p class="opacity-5"> <?php echo __("No likes recorded.","premiumpress") ?></p>
<?php } ?>
