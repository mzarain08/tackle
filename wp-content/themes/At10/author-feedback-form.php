...
<form id="addfeedbackform<?php echo $unidi; ?>" name="addfeedbackform" method="post" action="" onsubmit="return CHECKFEEDBACK<?php echo $unidi; ?>();"  class="mb-4">
   ...
   <?php if(isset($_GET['pid']) && is_numeric($_GET['pid']) ){ ?>
    ...
    <input type="hidden" name="comment_post_ID" value="<?php echo esc_attr($_GET['pid']); ?>" /> 
   ...
   <?php } ?> 
         ...
         <div class="form-group mt-4">
            ...
            <textarea rows="3" class="form-control msg"  style="height:100px;" name="message"><?php if(isset($_POST['message'])){ echo strip_tags(strip_tags($_POST['message'])); } ?></textarea>               
         </div>
      ...
      <label class="font-weight-bold "><?php echo __("How would you rate the overall transaction.","premiumpress"); ?></label>
      ...
      <?php $i++; } ?>  
         ...
         <div class="pt-3 border-top mt-3">
            <button class="btn-lg btn-dark" data-ppt-btn type="submit"><?php echo __("Submit Feedback","premiumpress"); ?></button>
         </div>
