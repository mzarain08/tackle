...
?>
 ...
 <script>
    ...
    <?php if($userdata->ID && _ppt(array('mem','enable')) == 1 && $CORE->USER("get_user_free_membership_addon", array("downloads", $userdata->ID)) < 1){ ?>
    
    <a onclick="processUpgrade();" class="btn btn-primary btn-lg btn-block dropdown-toggle py-3" id="downloadbutton" href="javascript:void(0);"><i class="fa fa-download mr-2 hide-mobile"></i> <?php echo __( 'Download File', 'premiumpress' ); ?></a>
    
    <div class="small text-center mt-3 opacity-8"><?php echo __( 'You have 0 download credit left.', 'premiumpress' ); ?></div>
    
    <?php  }elseif(!$userdata->ID && in_array(_ppt(array('design', 'display_photologin')), array("1"))  ){ ?>
    
    <a onclick="processLogin();" class="btn btn-primary btn-lg btn-block dropdown-toggle py-3" id="downloadbutton" href="javascript:void(0);"><i class="fa fa-download mr-2 hide-mobile"></i> <?php echo __( 'Download File', 'premiumpress' ); ?></a>
    
    <?php }else{ ?>
     <div class="btn-group btn-block">
   
      <button class="btn btn-primary btn-lg btn-block dropdown-toggle py-3" id="downloadbutton" type="button" <?php if(empty($DOWNLOADARRAY)){ echo "disabled"; } ?> data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
