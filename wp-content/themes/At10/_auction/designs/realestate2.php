...
add_filter( 'ppt_admin_layouts',  array('realestate2',  'data') );
add_filter( 'realestate2',  array('realestate2',  'load') );
...
class realestate2 {
	...
	public static function data($a){ 
		...
		$a['realestate2']["image"] = DEMO_IMG_PATH."/framework/layouts/_at/realestate/2.jpg";	
...
$core['design']['color_primary'] = "#325e8b";
$core['design']['color_primary_soft'] = "";
$core['design']['color_secondary'] = "#5a6164"; 
 
/* logo */
$core['design']['logo_url_aid'] = "";
$core['design']['light_logo_url_aid'] = "1";
$core['design']['textlogo'] = "Property<span class='text-light'>Auctions</span>";      
...
$core["home"]["hero4"]["image"] =  DEMO_IMG_PATH."/framework/layouts/_at/realestate/hero2.jpg";   
