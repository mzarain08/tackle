...
$core['design']['color_secondary'] = "#0c2b64";
        ...
        $core["home"]["listings2"]["title"] = "NEWLY <i class='fal fa-paint-brush hide-mobile mx-2 text-primary'></i> ADDED";     
        ...
        $core["home"]["icon8"]["title"] = "POPULAR <i class='fal fa-paint-brush hide-mobile mx-2 text-primary'></i> CATEGORIES";     
        ...
        $core["home"]["text2"]["title"] = "Welcome to <i class='fal fa-paint-brush hide-mobile ml-2 text-primary'></i> <span class='font-weight-bold text-uppercase'><u>Job</u>Board</span>";     
        ...
        $core["home"]["listings2a"]["title"] = "NEWLY <i class='fal fa-paint-brush hide-mobile mx-2 text-primary'></i> ADDED";     
        ...
        $core["home"]["subscribe2"]["title"] = "STAY <i class='fal fa-paint-brush hide-mobile mx-2 text-primary'></i> UPDATED";     
