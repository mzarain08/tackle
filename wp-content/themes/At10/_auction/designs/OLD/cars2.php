...
add_filter( 'ppt_admin_layouts',  array('at_cars2',  'data') );
add_filter( 'at_cars2',  array('at_cars2',  'load') );
...
class at_cars2 {
	...
	public static function data($a){ 
		...
		$a['at_cars2'] = array(
			...
			"name" 	=> "Car Auctions",
			"image"	=> _ppt_demopath()."/designs/cars2.jpg",
...
$core['design']['slot1_style'] = "hero_search1a";
...
$core['design']['slot9_style'] = '';
        ...
        /* hero_search1a */    
        $core["home"]["hero_search1a"]["section_padding"] = "section-80";     
        $core["home"]["hero_search1a"]["section_bg"] = "bg-light";     
        $core["home"]["hero_search1a"]["section_pos"] = "";     
        $core["home"]["hero_search1a"]["section_w"] = "container";     
        $core["home"]["hero_search1a"]["section_pattern"] = "";     
        $core["home"]["hero_search1a"]["title_show"] = "yes";     
        $core["home"]["hero_search1a"]["title"] = "Car Auction Theme";     
        $core["home"]["hero_search1a"]["subtitle"] = "Build your own auction website today!";     
        $core["home"]["hero_search1a"]["desc"] = " ";     
        $core["home"]["hero_search1a"]["title_style"] = "1";     
        $core["home"]["hero_search1a"]["title_pos"] = "left";     
        $core["home"]["hero_search1a"]["title_heading"] = "h1";     
        $core["home"]["hero_search1a"]["title_margin"] = "mb-2";     
        $core["home"]["hero_search1a"]["subtitle_margin"] = "mb-0";     
        $core["home"]["hero_search1a"]["desc_margin"] = "mb-0";     
        $core["home"]["hero_search1a"]["title_txtcolor"] = "light";     
        $core["home"]["hero_search1a"]["subtitle_txtcolor"] = "light";     
        $core["home"]["hero_search1a"]["desc_txtcolor"] = "dark";     
        $core["home"]["hero_search1a"]["title_font"] = "";     
        $core["home"]["hero_search1a"]["subtitle_font"] = "";     
        $core["home"]["hero_search1a"]["desc_font"] = "";     
        $core["home"]["hero_search1a"]["title_txtw"] = "text-700";     
        $core["home"]["hero_search1a"]["subtitle_txtw"] = "";     
        $core["home"]["hero_search1a"]["btn_show"] = "no";     
        $core["home"]["hero_search1a"]["btn_link"] = home_url()."/?s=";     
        $core["home"]["hero_search1a"]["btn_txt"] = "Search Website";     
        $core["home"]["hero_search1a"]["btn_bg"] = "orange";     
        $core["home"]["hero_search1a"]["btn_bg_txt"] = "text-light";     
        $core["home"]["hero_search1a"]["btn_icon"] = "fas fa-long-arrow-alt-right";     
        $core["home"]["hero_search1a"]["btn_icon_pos"] = "before";     
        $core["home"]["hero_search1a"]["btn_size"] = "btn-lg";     
        $core["home"]["hero_search1a"]["btn_margin"] = "mt-4";     
        $core["home"]["hero_search1a"]["btn_style"] = "1";     
        $core["home"]["hero_search1a"]["btn_font"] = "";     
        $core["home"]["hero_search1a"]["btn_txtw"] = "font-weight-bold";     
        $core["home"]["hero_search1a"]["btn2_show"] = "no";     
        $core["home"]["hero_search1a"]["hero_image"] = _ppt_demopath()."/cars/hero3.jpg";     
        $core["home"]["hero_search1a"]["hero_size"] = "hero-medium";     
        $core["home"]["hero_search1a"]["hero_overlay"] = "primary";     
        $core["home"]["hero_search1a"]["hero_txtcolor"] = "light"; 		
