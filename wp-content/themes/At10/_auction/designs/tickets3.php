...
add_filter( 'ppt_admin_layouts',  array('tickets3',  'data') );
add_filter( 'tickets3',  array('tickets3',  'load') );
...
class tickets3 {
	...
	public static function data($a){ 
		...
		$a['tickets3']["image"] = DEMO_IMG_PATH."/framework/layouts/_at/tickets/3.jpg";	
...
/* colors */
$core['design']['color_primary'] = "#f9c300";  
...
$core['design']['textlogo'] = "Tickets <span class='text-primary'>Auctions</span>";    
...
$core['home']['listings100']['title_underline_color'] = "#f9c300";
