...
add_filter( 'ppt_admin_layouts',  array('gym3',  'data') );
add_filter( 'gym3',  array('gym3',  'load') );
...
class gym3 {
	...
	public static function data($a){ 
		...
		$a['gym3']["image"] = DEMO_IMG_PATH."/framework/layouts/_at/gym/3.jpg";	
...
/* colors */
$core['design']['color_primary'] = "#ed7a30";  
...
$core['design']['textlogo'] = "Gym <span class='text-primary'>Auctions</span>";    
...
$core['home']['listings100']['title_underline_color'] = "#ed7a30";
