...
add_filter( 'ppt_admin_layouts',  array('cars2',  'data') );
add_filter( 'cars2',  array('cars2',  'load') );
...
class cars2 {
	...
	public static function data($a){ 
		...
		$a['cars2']["image"] = DEMO_IMG_PATH."/framework/layouts/_at/cars/2.jpg";	
...
$core['design']['textlogo'] = "Car <span class='text-secondary'>Auctions</span>";      
...
$core["home"]["hero4"]["image"] =  DEMO_IMG_PATH."/framework/layouts/_at/cars/hero2.jpg";   
