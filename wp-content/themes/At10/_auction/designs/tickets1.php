...
add_filter( 'ppt_admin_layouts',  array('tickets1',  'data') );
add_filter( 'tickets1',  array('tickets1',  'load') );
...
class tickets1 {
	...
	public static function data($a){ 
		...
		$a['tickets1']["image"] = DEMO_IMG_PATH."/framework/layouts/_at/tickets/1.jpg";	
...
$imgKey = "at";
		$core['design']['color_primary'] = "#c70312";		
...
$core['design']['textlogo'] = "Ticket <span class='text-primary'>Auctions</span>";    
...
$core["home"]["hero1"]["image"] = DEMO_IMG_PATH."/framework/layouts/_at/tickets/hero1.jpg";   
...
/* text1 */    
$core["home"]["text102"]["image"] = DEMO_IMG_PATH."/framework/layouts/_at/tickets/image1.jpg";   	
