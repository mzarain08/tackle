...
add_filter( 'ppt_admin_layouts',  array('realestate3',  'data') );
add_filter( 'realestate3',  array('realestate3',  'load') );
...
class realestate3 {
	...
	public static function data($a){ 
		...
		$a['realestate3']["image"] = DEMO_IMG_PATH."/framework/layouts/_at/realestate/3.jpg";	
...
/* colors */
$core['design']['color_primary'] = "#2c5b89";  
$core['design']['color_secondary'] = "#777f8c";
...
$core['design']['textlogo'] = "Property <span class='text-primary'>Auctions</span>";    
...
$core['header']['header130']['header_bg_color'] = "#777f8c"; 
 
$core['home']['search1']['section_bg_color'] = "#777f8c";
 

$core['home']['listings100']['title'] = "{Featured} Auctions";
$core['home']['listings100']['title_underline'] = "12";
$core['home']['listings100']['title_underline_color'] = "#2c5b89";
