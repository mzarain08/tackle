...
add_filter( 'ppt_admin_layouts',  array('realestate1',  'data') );
add_filter( 'realestate1',  array('realestate1',  'load') );
...
class realestate1 {
	...
	public static function data($a){ 
		...
		$a['realestate1']["image"] = DEMO_IMG_PATH."/framework/layouts/_at/realestate/1.jpg";	
...
$core["home"]["hero1"]["image"] = DEMO_IMG_PATH."/framework/layouts/_at/realestate/hero1.jpg";   
...
/* text1 */    
$core["home"]["text102"]["image"] = DEMO_IMG_PATH."/framework/layouts/_at/realestate/image1.jpg";   	
