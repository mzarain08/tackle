...
add_filter( 'ppt_admin_layouts',  array('horses2',  'data') );
add_filter( 'horses2',  array('horses2',  'load') );
...
class horses2 {
	...
	public static function data($a){ 
		...
		$a['horses2']["image"] = DEMO_IMG_PATH."/framework/layouts/_at/horses/2.jpg";	
...
$core['design']['color_primary'] = "#6e4b35";
...
$core['design']['textlogo'] = "Horse <span class='text-secondary'>Auctions</span>";      
...
$core["home"]["hero4"]["image"] =  DEMO_IMG_PATH."/framework/layouts/_at/horses/hero2.jpg";   
