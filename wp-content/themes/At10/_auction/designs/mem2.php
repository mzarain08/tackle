...
add_filter( 'ppt_admin_layouts',  array('mem2',  'data') );
add_filter( 'mem2',  array('mem2',  'load') );
...
class mem2 {
	...
	public static function data($a){ 
		...
		$a['mem2']["image"] = DEMO_IMG_PATH."/framework/layouts/_at/memorabilia/2.jpg";	
...
$core['design']['color_primary'] = "#1e391d";
...
$core['design']['textlogo'] = "Memorabilia <span class='text-secondary'>Auctions</span>";      
...
$core["home"]["hero4"]["image"] =  DEMO_IMG_PATH."/framework/layouts/_at/memorabilia/hero2.jpg";   
