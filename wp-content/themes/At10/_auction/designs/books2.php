...
add_filter( 'ppt_admin_layouts',  array('books2',  'data') );
add_filter( 'books2',  array('books2',  'load') );
...
class books2 {
	...
	public static function data($a){ 
		...
		$a['books2']["image"] = DEMO_IMG_PATH."/framework/layouts/_at/books/2.jpg";	
...
$core['design']['color_primary'] = "#8d0101";
...
$core['design']['textlogo'] = "Comic <span class='text-secondary'>Auctions</span>";      
...
$core["home"]["hero4"]["image"] =  DEMO_IMG_PATH."/framework/layouts/_at/books/hero2.jpg";   
