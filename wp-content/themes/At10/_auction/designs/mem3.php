...
add_filter( 'ppt_admin_layouts',  array('mem3',  'data') );
add_filter( 'mem3',  array('mem3',  'load') );
...
class mem3 {
	...
	public static function data($a){ 
		...
		$a['mem3']["image"] = DEMO_IMG_PATH."/framework/layouts/_at/memorabilia/3.jpg";	
...
/* colors */
$core['design']['color_primary'] = "#0b9b3d";  
...
$core['home']['listings100']['title_underline_color'] = "#0b9b3d";
