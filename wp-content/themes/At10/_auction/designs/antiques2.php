...
add_filter( 'ppt_admin_layouts',  array('antiques2',  'data') );
add_filter( 'antiques2',  array('antiques2',  'load') );
...
class antiques2 {
	...
	public static function data($a){ 
		...
		$a['antiques2']["image"] = DEMO_IMG_PATH."/framework/layouts/_at/antiques/2.jpg";	
...
$core['design']['textlogo'] = "Simply<span class='text-black'>Antiques</span>";      
...
$core["home"]["hero4"]["image"] =  DEMO_IMG_PATH."/framework/layouts/_at/antiques/hero2.jpg";   
