  ...
  <div class="_content border-top ">
    ...
    <div class="pb-2  mt-2" ppt-flex-between>
      <div class="text-600">
            ...
            <span ppt-icon-24 data-ppt-icon-size="24" class="text-secondary"><?php echo $CORE_UI->icons_svg['clock']; ?></span> <?php echo $timer; ?> </div>
...
<div class="show-mobile">
  <div class="position-relative mb-3">
    ...
    <div class="fs-14 text-600" style="margin-top:10px;">%title%</div>
    ...
    <div class="fs-sm text-dark link-dark text-truncate" style="max-width:150px;"> <?php echo $timer; ?> </div>
    </div>
  </div>
</div> 