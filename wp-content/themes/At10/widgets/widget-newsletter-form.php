...
<input type="text" name="ppt_newsletter_mailme<?php echo $randomID; ?>" id="ppt_newsletter_mailme<?php echo $randomID; ?>" value="" placeholder="<?php echo __("Email Address Here..","premiumpress") ?>" style="height:46px;" class="form-control  rounded-0" /> 
