...
add_filter( 'ppt_admin_layouts',  array('svg1c',  'data') );
add_filter( 'svg1c',  array('svg1c',  'load') );
...
class svg1c {
	...
	public static function data($a){ 
		...
		switch(THEME_KEY){ 
			...
			default: {
				$a['svg1c']["image"] = DEMO_IMG_PATH."/framework/layouts/svg/d/3.jpg";				
			} break; 
		}	
...
$core['design']['color_primary'] = "#6a11cb";
...
/*layout data */
$core['design']['slot1_style'] = "hero104";
