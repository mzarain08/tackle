...
add_filter( 'ppt_admin_layouts',  array('oct2021d',  'data') );
add_filter( 'oct2021d',  array('oct2021d',  'load') );
...
class oct2021d {
	...
	public static function data($a){ 
		...
		switch(THEME_KEY){			 
			...
			case "da":
			case "es": {
			$a['oct2021d']["image"] = DEMO_IMG_PATH."/framework/layouts/oct2021/".THEME_KEY."/4.jpg";
			} break;
			default: {
				$a['oct2021d']["image"] = DEMO_IMG_PATH."/framework/layouts/oct2021/d/4.jpg";			
			} break; 
		}			 
...
$core['design']['footer_style'] = "footer12";
...
/* hero*/
$core["home"]["hero3"]["image"] = DEMO_IMG_PATH."/framework/layouts/oct2021/".$imgKey."/hero4.jpg";   
$core["home"]["hero3"]["title"] = "Looking for <br /> [".$CORE->LAYOUT("get_placeholder_text_new", array("code", "typewriter" ) )."]";
$core["home"]["hero3"]["title_animated"] = "ppt-animate-typed"; 
$core["home"]["hero3"]["subtitle"] = "We have hundreds of talented people waiting to hear from you, what are you looking for?";
 

$core["home"]["text102"]["image"] = DEMO_IMG_PATH."/framework/layouts/oct2021/".$imgKey."/image4.jpg";   
