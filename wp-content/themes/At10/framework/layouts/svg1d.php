...
add_filter( 'ppt_admin_layouts',  array('svg1d',  'data') );
add_filter( 'svg1d',  array('svg1d',  'load') );
...
class svg1d {
	...
	public static function data($a){ 
		...
		switch(THEME_KEY){ 
			...
			default: {
				$a['svg1d']["image"] = DEMO_IMG_PATH."/framework/layouts/svg/d/4.jpg";				
			} break; 
		}	
...
$core['design']['color_primary'] = "#8abb1d";
...
/*layout data */
$core['design']['slot1_style'] = "hero106";
