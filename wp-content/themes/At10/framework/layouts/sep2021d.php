...
add_filter( 'ppt_admin_layouts',  array('sep2021d',  'data') );
add_filter( 'sep2021d',  array('sep2021d',  'load') );
	...
	public static function data($a){ 
		...
		switch(THEME_KEY){
			...
			case "sp":
		 	case "da":
			case "es": {
			$a['sep2021d']["image"] = DEMO_IMG_PATH."/framework/layouts/sep2021/".THEME_KEY."/4.jpg";
			} break;
			default: {
			$a['sep2021d']["image"] = DEMO_IMG_PATH."/framework/layouts/sep2021/d/4.jpg";
			} break; 
		}
...
switch(THEME_KEY){
	...
	default: { 
		$core['design']['color_primary'] = "#2a2a2a";
...
$core['searchcustom']['cardlayout'] = "list";
...
$core["header"]["header102"]["topmenu_bg"] = "bg-primary";

switch(THEME_KEY){

	case "sp": {
	$core['design']['slot1_style'] = "listings102";
	}
}
