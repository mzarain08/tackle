...
add_filter( 'ppt_admin_layouts',  array('svg1b',  'data') );
add_filter( 'svg1b',  array('svg1b',  'load') );
...
class svg1b {
	...
	public static function data($a){ 
		...
		switch(THEME_KEY){ 
			...
			default: {
				$a['svg1b']["image"] = DEMO_IMG_PATH."/framework/layouts/svg/d/2.jpg";				
			} break; 
		}	
...
$core['design']['color_primary'] = "#37b785";
...
/*layout data */
$core['design']['slot1_style'] = "hero103";
