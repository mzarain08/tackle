...
add_filter( 'ppt_admin_layouts',  array('nov2021a',  'data') );
add_filter( 'nov2021a',  array('nov2021a',  'load') );
...
class nov2021a {
	...
	public static function data($a){ 
		...
		switch(THEME_KEY){
			...
			case "es":
			case "so": {
				$a['nov2021a']["image"] = DEMO_IMG_PATH."/framework/layouts/nov2021/".THEME_KEY."/1.jpg";	
			} break;
			default: {
				$a['nov2021a']["image"] = DEMO_IMG_PATH."/framework/layouts/nov2021/d/1.jpg";				
			} break; 
		}			 
...
/*layout data */
$core['design']['slot1_style'] = "hero10";
