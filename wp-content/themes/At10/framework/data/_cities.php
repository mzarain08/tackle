...
"GB-NIR" => "Antrim|Ballycastle|Ballyclare|Ballymena|Ballymoney|Ballynahinch|Banbridge|Bangor|Belfast|Carrickfergus|Carryduff|Coalisland|Coleraine|Comber|Cookstown|Craigavon|Downpatrick|Dromore|Dundonald|Dungannon|Dunmurry|Enniskillen|Holywood",
...
"AL" => "Berat|Bulqize|Delvine|Devoll|Diber|Durres|Elbasan|Fier|Gjirokaster|Gramsh|Has Krume|Kavaje|Kolonje|Korce|Kruje|Kucove|Kukes|Kurbin|Lezhe|Librazhd|Lushnje|Malesi e Madhe [Koplik|Mallakaster|Mat|Mirdite|Peqin|Permet|Pogradec|Puke|Sarande|Shkoder|Skrapar|Tepelene|Tirane|Tirane|Tropoje Bajram Curri|Vlore",
 ...
 'AR' => 'Buenos Aires|Buenos Aires Capital Federal|Catamarca|Chaco|Chubut|Cordoba|Corrientes|Entre Rios|Formosa|Jujuy|La Pampa|La Rioja|Mendoza|Misiones|Neuquen|Rio Negro|Salta|San Juan|San Luis|Santa Cruz|Santa Fe|Santiago del Estero|Tierra del Fuego|Tucuman', 
...
'NC' => 'la Province Sud|la Province Nord et|la Province des îles Loyauté',
...
'DK'=> 'Nordjylland|Midtjylland|Ostjylland|Sonderjylland|Vestjylland|Fyn|Kobenhavnsomradet|Nordsjalland|Midtsjalland|Vestsjalland|Sydsjalland|Lolland Falster|Bornholm|Faroerne|Gronland|Andet',
...
'FR'=> "Auvergne-Rhône-Alpes|Bourgogne-Franche-Comté|Bretagne|Centre-Val de Loire|Corse|Grand Est|Hauts-de-France|Île-de-France|Normandie| Nouvelle-Aquitaine|Occitanie|Pays de la Loire|Provence-Alpes-Côte d'Azur|Guadeloupe|Martinique|Guyane|La Réunion|Mayotte",
'GF'=> 'French Guiana',
...
'RU' => 'Moscow|Saint Petersburg|Novosibirsk|Yekaterinburg|Nizhny Novgorod|Samara|Kazan|Omsk|Chelyabinsk|Rostov-on-Don|Ufa|Volgograd|Perm|Krasnoyarsk|Voronezh|Saratov|Tolyatti|Krasnodar|Izhevsk|Yaroslavl|Maykop|Gorno-Altaysk|Ulan-Ude|Makhachkala|Petrozavodsk|Yoshkar-Ola|Saransk|Yakutsk|Vladikavkaz|Stavropol|Vladivostok|Barnaul|Khabarovsk|Astrakhan|Vladimir|Kaliningrad|Petropavlovsk-Kamchatsky|Kemerovo|Veliky Novgorod|Orenburg|Pskov|Tula',  
...
'SS' => 'South Sudan',  
'ES' => 'Albacete|Alicante|Almería|Asturias|Badajoz|Islas Baleares|Barcelona|Bizcaya|Burgos|Cantabria|Castellón|Ciudad Real|Cuenca|Cáceres|Cádiz|Córdoba|Gerona|Granada|Guadalajara|Guipúzcoa|Huelva|Huesca|Jaén|La Coruña|La Rioja|Las Palmas|León|Lugo|Lérida|Madrid|Murcia|Málaga|Navarra|Orense|Palencia|Pontevedra|Salamanca|Santa Cruz|Segovia|Sevilla|Soria|Tarragona|Teruel|Toledo|Valencia|Valladolid|Zamora|Zaragoza|Álava|Sevilla',
...
'TH' => 'Amnat Charoen|Ang Thong|Bangkok|Buriram|Chachoengsao|Chai Nat|Chaiyaphum|Chanthaburi|Chiang Mai|Chiang Rai|Chon Buri|Chumphon|Kalasin|Kamphaeng Phet|Kanchanaburi|Khon Kaen|Krabi|Krung Thep Mahanakhon|Lampang|Lamphun|Loei|Lop Buri|Mae Hong Son|Maha Sarakham|Mukdahan|Nakhon Nayok|Nakhon Pathom|Nakhon Phanom|Nakhon Ratchasima|Nakhon Sawan|Nakhon Si Thammarat|Nan|Narathiwat|Nong Bua Lamphu|Nong Khai|Nonthaburi|Pathum Thani|Pattani|Phangnga|Phatthalung|Phayao|Phetchabun|Phetchaburi|Phichit|Phitsanulok|Phra Nakhon Si Ayutthaya|Phrae|Phuket|Prachin Buri|Prachuap Khiri Khan|Ranong|Ratchaburi|Rayong|Roi Et|Sa Kaeo|Sakon Nakhon|Samut Prakan|Samut Sakhon|Samut Songkhram|Sara Buri|Satun|Sing Buri|Sisaket|Songkhla|Sukhothai|Suphan Buri|Surat Thani|Surin|Tak|Trang|Trat|Ubon Ratchathani|Udon Thani|Uthai Thani|Uttaradit|Yala|Yasothon',  
'Timor-Leste', 
