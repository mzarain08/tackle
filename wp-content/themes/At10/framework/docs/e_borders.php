...
$flex = array("ppt-border1","ppt-border2","ppt-border3");

 ?>
<h2 class="mb-4">Border Styles</h2>

 
<div class="row">
<?php foreach($flex as $f){ ?>
<div class="col-md-4 mb-4"> 
	<div style="height:100px;" <?php echo $f; ?>  ppt-flex-middle>.<?php echo $f; ?></div> 
</div>
<?php } ?>
</div>
<?php
...
<?php foreach($flex as $f){ ?>
<div class="col-md-4 mb-4"> 
	<div style="height:100px;" <?php echo $f; ?> ppt-rounded ppt-flex-middle>.<?php echo $f; ?></div> 
</div>
<?php } ?>
</div>
<?php
