...
<a href="javascript:void(0);"  onclick="ajax_banner_delete('<?php echo $post->ID; ?>')" class="btn btn-system btn-md  btn-block  font-weight-bold tiny"><?php echo __("Delete","premiumpress"); ?></a>
