...
global $settings;
  ...
  "desc" => "Here is an overview of the typography changes within this framework",
  "back" => "overview",
...
<div class="card card-admin">
  <div class="card-body">
    <h3 class="my-4"> Bootstrap 4.6.1
      <div class="title-divider-round"></div>
    </h3>
    <p class="lead">All PremiumPress themes and child themes are built using the Bootstrap CSS framework.</p>
    <a href="https://getbootstrap.com/docs/4.6/content/typography/" target="_blank" class="btn btn-primary btn-xl mb-3 py-3"> <span class="btn-inner-icon"><i class="fas fa-info-circle"></i></span> <span class="btn-inner-text">Bootstrap 4 documentation</span> </a>
    <div class="mt-4"> <a href="<?php echo home_url(); ?>/?ppt_live_preview=1&amp;tid=typography" target="_blank" class="btn btn-primary btn-xl color2">Load Playground</a> </div>
