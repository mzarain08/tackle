...
<div class="clearfix mb-4">
  <button type="button" onclick="jQuery('#add-tab').tab('show');"  class="<?php if($CORE->GEO("is_right_to_left", array() )){ echo "float-left"; }else{ echo "float-right"; } ?> btn btn-primary btn-xl"> <span class="btn-label"><i class="fa fa-plus"></i></span> <?php echo __("Add Log","premiumpress"); ?></button>
  
  <h3 class="my-4"> <span class="ajax-search-found"></span> <?php echo __("Logs Found","premiumpress"); ?></h3>
