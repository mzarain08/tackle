...
<a href="javascript:void(0);" onClick="jQuery('#ppt_custom_methods_box').clone().prependTo('#ppt_shipping_methods');" class="btn btn-system btn-md  float-right"><i class="fal fa-plus"></i> <?php echo __("Add New","premiumpress"); ?></a>	   
...
<li class="cfielditem" id="ccs-<?php echo $i; ?>"> 
    ...
    <div id="ccs-inner<?php echo $i; ?>"  style="display:none;padding:20px;">            
      ...
      <label><?php echo __("Display Caption","premiumpress"); ?></label>
