...
<a href="javascript:void(0);" onClick="jQuery('#ppt_weightbox').clone().prependTo('#ppt_weightbased_shpping');" class="btn btn-system btn-md  float-right">
<?php echo __("Add New","premiumpress"); ?></a>
...
if(is_array( $regions )){ 
	...
	$c++;
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="input-group"> <span class="add-on input-group-prepend"><span class="input-group-text"><?php if(strpos( _ppt(array('currency','symbol')), "fa") === false){ echo hook_currency_symbol('');  }else{ echo '<i class="'._ppt(array('currency','symbol')).'"></i>'; } ?></span></span>
