...
$defaulticon = ppt_default_tax_icon($taxonomy);
...
if( in_array($taxonomy, array("dagender","dasexuality","dathnicity","daeyes","dahair","dabody","dasmoke","dahairlenght", "dadrink","features","condition", "make", "model", "condition", "body", "fuel", "transmission", "exterior", "interior", "doors", "seller", "engine", "drive","owners", "beds","baths", 'experience', 'jobtype','color','size')) ){
$defaultlistingtax = 1;
