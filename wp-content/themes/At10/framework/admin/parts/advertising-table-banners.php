...
<div class="clearfix mb-3">
     ...
     <button type="button"  onclick="jQuery('#UpdateModal').modal('show');"  class="<?php if($CORE->GEO("is_right_to_left", array() )){ echo "float-left"; }else{ echo "float-right"; } ?> btn btn-primary btn-lg"><i class="fa fa-plus"></i> <?php echo __("Add Banner","premiumpress"); ?></button>
    
     
    <h3 class="mb-2"><span class="ajax-search-found1"></span> <?php echo __("Banners","premiumpress"); ?></h3>
...
<div id="ajax_response_msg1"></div>  
    ...
    <div class="row mb-3">   
        ...
        <!--<a href="javascript:void(0);" class="btn btn-primary btn-xl color3" onclick="showfilersbar();"><i class="fa fa-filter"></i> <?php echo __("Show Filters","premiumpress"); ?> </a>-->
