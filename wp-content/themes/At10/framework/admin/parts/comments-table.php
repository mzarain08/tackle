  ...
  <ul>
    <li>
      <div class="fs-md text-600">
        <span class="ajax-search-found"></span> <?php echo __("Comments","premiumpress"); ?>
      </div>
    </li>
    <li class="ml-auto"> <a href="#"  onclick="jQuery('#add-tab').tab('show');"  class="btn-primary btn-lg" data-ppt-btn>
    <span class="ml-2"><?php echo __("Add Comment","premiumpress"); ?></span> </a> </li>
  </ul>
</nav>
<hr />
...
<input type="hidden" name="cardtype" value="admin-comments" class="customfilter"  data-type="select" data-key="cardtype" />
                    ...
                    <thead>
                        <tr>  
                           ...
                           <th class="text-center">&nbsp;  </th>
							...
							<th><?php echo __("Rating","premiumpress"); ?> </th>
                            
                            
                        	<th><?php echo __("Comments","premiumpress"); ?></th>
...
function ajax_massupdate_listings(){
    ...
    jQuery.ajax({
		...
		dataType: 'json',	
		data: {
            admin_action: "mass_update_comments",
			pids: ids,
