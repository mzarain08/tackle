...
<a href="<?php echo home_url(); ?>/wp-admin/admin.php?page=email&eid=<?php echo $post->ID; ?>" class="btn btn-system btn-md  btn-block"><?php echo __("Edit","premiumpress"); ?> </a>

<a href="javascript:void(0);"  onclick="ajax_delete_subscriber('<?php echo $post->ID; ?>')"  class="btn btn-system btn-md  btn-block"><?php echo __("Delete","premiumpress"); ?></a>
