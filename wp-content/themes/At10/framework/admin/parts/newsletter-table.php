  ...
  <ul>
    <li>
      <div class="fs-md text-600">
        <span class="ajax-search-found"></span> <?php echo __("Subscribers","premiumpress"); ?>
      </div>
    </li>
...
<div class="card card-admin p-4">  
    ...
    <div class="row mb-3">   
        ...
        <a href="javascript:void(0);" class="btn btn-system btn-sm" onclick="showfilersbar();"><i class="fa fa-filter"></i> <?php echo __("Show Filters","premiumpress"); ?> </a>
