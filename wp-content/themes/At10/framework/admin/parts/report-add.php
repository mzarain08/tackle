...
$log_extra = get_post_meta($_GET['eid'], "log_extra", true);
      ...
      <div class="row mt-4">
        ...
        <div class="form-group col-6">
          ...
          <div <?php if(isset($_GET['eid']) && $postid == ""){  ?>style="display:none;"<?php } ?>>
            ...
            <div <?php if(isset($_GET['eid']) && $log_extra == ""){  ?>style="display:none;"<?php } ?>>
            <label><?php echo __("Extra","premiumpress"); ?></label>
            <div class="input-group">
              <div class="input-group-prepend"> <span class="input-group-text"> # </span> </div>
              <input name="log[log_extra]" class="form-control"  type="text" value="<?php if(isset($_GET['eid'])){ echo $log_extra;  }?>">
            </div>
          </div>
