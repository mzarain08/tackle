...
<div class="clearfix mb-2">
  <a  href="admin.php?page=advertising&lefttab=add" class="<?php if($CORE->GEO("is_right_to_left", array() )){ echo "float-left"; }else{ echo "float-right"; } ?> btn  btn btn-primary btn-lg font-weight-bold btn-icon icon-before">
  <i class="fa fa-plus"></i> <span style="min-width:200px;"><?php echo __("Add Campaign","premiumpress"); ?></span></a>
  <h3 class="mt-3"><span class="ajax-search-found"></span> <?php echo __("Campaigns","premiumpress"); ?></h3>
