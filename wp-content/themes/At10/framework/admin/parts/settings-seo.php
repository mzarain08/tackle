...
global $settings, $CORE, $CORE_ADMIN;
  ...
  "doclink" => "https://www.premiumpress.com/docs/plugins/",
          ...
          <div class="accordion border mt-4" id="accPackages">
            ...
            <div id="collapse<?php echo $i; ?>" class="collapse <?php if($i == 0){ echo "show"; } ?>" aria-labelledby="heading<?php echo $i; ?>" data-parent="#accPackages">
             ...
             <div class="position-relative">
              <input class="whitebg form-control" style="width:90%" onkeyup="titleStrength('<?php echo $k; ?>', 0);" name="admin_values[seo][<?php echo $k; ?>_title]" id="<?php echo $k; ?>_title" value="<?php if(_ppt(array('seo', $k.'_title')) == ""){  echo $page['default']; }else{ echo _ppt(array('seo', $k.'_title')); } ?>" />
...
<div class="position-relative">
              <input class="whitebg form-control mb-4" style="width:90%"
...
<div class="position-relative">
              <input class="whitebg form-control" style="width:90%"
...
<?php $count++; } } ?>
              ...
              <div id="<?php echo $k; ?>_extra" style="display:none;">
                  ...
                  <input class="whitebg form-control" name="admin_values[seo][<?php echo $k; ?>_keywords]" value="<?php echo _ppt(array('seo', $k.'_keywords')); ?>" />
                  </div>
                  
                  <div class="">
                  <label>Description</label>
                  <textarea class="whitebg form-control" style="height:200px !important;" name="admin_values[seo][<?php echo $k; ?>_desc]"><?php echo _ppt(array('seo', $k.'_desc')); ?></textarea>
  ...
  <div class="row">
    ...
    <div class="col-md-4">
      <div class="input-group mb-2">
         ...
         <a href="<?php echo home_url(); ?>/wp-admin/plugin-install.php?tab=plugin-information&plugin=wordpress-seo" class="btn btn-primary btn-xl color2"><?php echo __("Install Plugin","premiumpress"); ?></a>
  ...
  <div class="row">
    ...
    <div class="col-md-4">
      <div class="input-group mb-2">
         ...
         <a href="<?php echo home_url(); ?>/wp-admin/plugin-install.php?tab=plugin-information&plugin=seo-by-rank-math" class="btn btn-primary btn-xl color2"><?php echo __("Install Plugin","premiumpress"); ?></a>
