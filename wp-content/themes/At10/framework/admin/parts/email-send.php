...
global $CORE, $wpdb, $userdata, $CORE_UI;
...
<div class="container px-0">
    <div class="row">
        ...
        <?php if(isset($_GET['uid'])){ ?>
         ...
         <h3 class="mt-4"><?php echo __("Email","premiumpress"); ?> <?php echo $CORE->USER("get_username", $_GET['uid']); ?></h3>  
        
        
        <?php echo $CORE_UI->AVATAR("user", array("size" => "xl", "uid" =>$_GET['uid'], "css" => "rounded")); ?>
        ...
        <div class="mt-4">
 <a href="#" onclick="jQuery('#overview-tab').trigger('click');" class="btn btn-light font-weight-bold text-uppercase tiny"><i class="fa fa-arrow-left mr-1"></i> <?php echo __("go back","premiumpress"); ?></a>
 </div>
...
<div class="row my-3" style="<?php if(strlen($emailto) > 1){ ?>display:none;<?php } ?>">

<div class="col-md-6">
<div class="bg-light p-3 rounded">
<input type="radio"  value="1" name="senttogo" onclick="jQuery('#eeu').hide();" <?php if(strlen($emailto) == 0){ ?>checked="checked"<?php } ?> /> <i class="fa fa-users text-muted float-right fa-2x mt-n2" style="opacity:0.1"></i>  <?php echo __("All Users","premiumpress"); ?>
</div>
</div>

<div class="col-md-6">
<div class="bg-light p-3 rounded">
<input type="radio"  value="2" name="senttogo" onclick="jQuery('#eeu').show();  jQuery('#ueem').hide();" <?php if(strlen($emailto) > 1){ ?>checked="checked"<?php } ?>/> <i class="fa fa-envelope text-muted float-right mt-n2 fa-2x" style="opacity:0.1"></i>  <?php echo __("Email Address","premiumpress"); ?>
</div>
</div>
</div>
...
if(isset($_GET['testemail'])){
 ...
 echo wp_editor( $content, 'message', array( 'textarea_name' => 'message', 'editor_height' => '300px !important', 'media_buttons' => FALSE ) );  ?>                        
</div>
...
<div class="p-4 bg-light text-center mt-4">
         <button type="submit" data-ppt-btn class="btn-primary"><?php echo __("Send Email","premiumpress"); ?></button>
    	</div>
