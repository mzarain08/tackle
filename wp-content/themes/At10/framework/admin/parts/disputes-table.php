  ...
  <ul>
    <li>
      <div class="fs-md text-600">
        <span class="ajax-search-found"></span> <?php echo __("Disputes","premiumpress"); ?>
      </div>
    </li>
    <li class="ml-auto">
    
  <button type="button" onclick="jQuery('#add-tab').tab('show');" data-ppt-btn  class="btn-primary btn-lg"><?php echo __("Add Dispute","premiumpress"); ?></button>
...
<input type="hidden" name="cardtype" value="admin-dispute" class="customfilter"  data-type="select" data-key="cardtype" />
    ...
    <ul>
      <li>
        <nav ppt-nav class="boxed pill shadow-sm fs-7 text-600">
          <ul>
            <li class="cursor" onclick="UpdateStatusT('1');"><a href="#"><?php echo __("Pending","premiumpress"); ?></a></li>
             
            <li class="cursor" onclick="UpdateStatusT('2');"><a href="#"><?php echo __("Approved","premiumpress"); ?></a></li>
            
            <li class="cursor" onclick="UpdateStatusT('3');"><a href="#"><?php echo __("Rejected","premiumpress"); ?></a></li>
          </ul>
        </nav>
      </li>
...
function customsortby1(v){
	...
	_filter_update();
      ...
      <div class="col-md-12 px-0 bg-light border-top" style="display:none;" id="filterssidebox">
        <?php _ppt_template('framework/admin/parts/disputer-table-filters' ); ?>
      </div>
          ...
          <table class="table table-striped table-hover">
            <thead>
              <tr>
               ...
               <th style="width:250px;"><?php echo __("Users","premiumpress"); ?> </th>
                ...
                <th ><?php echo __("Date","premiumpress"); ?>
