...
<h6><?php echo __("Order Status","premiumpress"); ?></h6>
<hr />
<?php
...
<input type="checkbox"  value="<?php echo $k; ?>" class="custom-control-input customfilter getstatscheck" onclick="_filter_update()" id="order_status_<?php echo $k; ?>_check" data-key="orderstatus" data-value="<?php echo $k; ?>" data-old-value="" data-type="checkbox" <?php if(isset($_GET['order_status']) && $_GET['order_status'] == $k){ echo "checked=checked"; } ?>>
...
<h6><?php echo __("Order Type","premiumpress"); ?></h6>
<hr />
<?php
...
<?php } ?>
 ...
 <h6><?php echo __("Order Process","premiumpress"); ?></h6>
<hr />
