...
// ADD ON STYLES
wp_enqueue_style('addform', CDN_PATH.'css/_submitform.css');
wp_enqueue_style('addform');
 
wp_enqueue_script('addform1', CDN_PATH.'js/js.plugins-upload.js');
...
function addNewCat(){
   ...
   <?php /*
          <div class="p-4 bg-light text-center mt-4">
            <button type="submit" data-ppt-btn class="btn-primary"><?php echo __("Continue","premiumpress"); ?></button>
          </div>
        */ ?>
