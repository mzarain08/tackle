...
<div class="p-4 bg-light">
  <div class="col-12">
    ...
    <select name="admin_values[lang][default]" class="form-control mb-4 whitebg" style="font-size: 18px !important;    height: 50px !important;">
      <?php
...
<div class="col-12 border-top py-3 mt-4">
  <div class="row">
	...
	*/ ?>
       ...
       <?php if(get_option("ppt_translations") != ""){ ?>
        <hr />
        
        <div>
        
        <a href="admin.php?page=settings&lefttab=lang&resetlang=1" class="confirm" data-ppt-primary><i class="fa fa-sync mr-3"></i> <?php echo __("Reset Language Editor","premiumpress"); ?></a>
