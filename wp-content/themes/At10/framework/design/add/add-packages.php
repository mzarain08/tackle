...
package["<?php echo $n['key']; ?>"] = {
			...
			videos: <?php if($noPaks){ if(!is_numeric( _ppt(array('lst','default_videos')))){ echo 10; }else{ echo _ppt(array('lst','default_videos')); } }elseif(_ppt(array('lst','websitepackages')) == 0){ echo 10; }elseif(_ppt('pak'.$n['key'].'_videos') == ""){ echo 5; }else{ echo _ppt('pak'.$n['key'].'_videos'); } ?>,
