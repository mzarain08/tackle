...
<h3 class="block-header__title"><?php echo __("Price Comparison","premiumpress"); ?></h3>
<div class="block-header__divider"></div> 
    ...
    <div id="showstoresdrop" style="max-height:500px; overflow-y:scroll;">
    ...
    <button type="button" class="btn btn-system shadow-sm font-weight-bold" onclick="add_compare_row();"><?php echo __("Add New","premiumpress"); ?></button>
          ...
          <div class="container">
            <div class="row mb-4 mt-3">
              ...
              <div class="col position-relative">
                ...
                <?php if(is_admin()){ ?>
                <span class="input-group-addon" style="top: 10px;    right: 30px;    position: absolute;    z-index: 100;"> <a href="javascript:void(0);" onclick="add_compare_image(this)" class="text-dark"><span class="fal fa-camera"></span></a></span> 
                <?php } ?>
