  ...
  <div class="col-lg-8 mx-auto text-center mb-4">
   ...
   <div class="col-md-10 mx-auto">
      <div class="row no-gutters">
         <?php $i=1; while($i < 5){ ?>
         <div class="col-md-6">
            <div class="card py-md-4 mb-md-0 border-0" style=" border-bottom: 1px solid rgba(120, 130, 140, 0.13) !important; <?php if($i%2){ ?>border-right: 1px solid rgba(120, 130, 140, 0.13) !important;<?php } ?>">
