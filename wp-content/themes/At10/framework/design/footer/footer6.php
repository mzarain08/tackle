...
add_filter( 'ppt_blocks_args', 	array('block_footer6',  'data') );
add_action( 'footer6',  		array('block_footer6', 'output' ) );
add_action( 'footer6-css',  	array('block_footer6', 'css' ) );
add_action( 'footer6-js',  	array('block_footer6', 'js' ) );
