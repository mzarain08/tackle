...
add_filter( 'ppt_blocks_args', 	array('block_footer19',  'data') );
add_action( 'footer19',  		array('block_footer19', 'output' ) );
add_action( 'footer19-css',  	array('block_footer19', 'css' ) );
add_action( 'footer19-js',  	array('block_footer19', 'js' ) );

class block_footer19 {
