...
add_filter( 'ppt_blocks_args', 	array('block_footer16',  'data') );
add_action( 'footer16',  		array('block_footer16', 'output' ) );
add_action( 'footer16-css',  	array('block_footer16', 'css' ) );
add_action( 'footer16-js',  	array('block_footer16', 'js' ) );

class block_footer16 {
