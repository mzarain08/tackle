...
add_filter( 'ppt_blocks_args', 	array('block_footer15',  'data') );
add_action( 'footer15',  		array('block_footer15', 'output' ) );
add_action( 'footer15-css',  	array('block_footer15', 'css' ) );
add_action( 'footer15-js',  	array('block_footer15', 'js' ) );

class block_footer15 {
