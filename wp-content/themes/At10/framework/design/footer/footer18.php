...
add_filter( 'ppt_blocks_args', 	array('block_footer18',  'data') );
add_action( 'footer18',  		array('block_footer18', 'output' ) );
add_action( 'footer18-css',  	array('block_footer18', 'css' ) );
add_action( 'footer18-js',  	array('block_footer18', 'js' ) );

class block_footer18 {
