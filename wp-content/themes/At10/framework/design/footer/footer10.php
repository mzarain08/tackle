...
add_filter( 'ppt_blocks_args', 	array('block_footer10',  'data') );
add_action( 'footer10',  		array('block_footer10', 'output' ) );
add_action( 'footer10-css',  	array('block_footer10', 'css' ) );
add_action( 'footer10-js',  	array('block_footer10', 'js' ) );

class block_footer10 {
