...
add_filter( 'ppt_blocks_args', 	array('block_footer14',  'data') );
add_action( 'footer14',  		array('block_footer14', 'output' ) );
add_action( 'footer14-css',  	array('block_footer14', 'css' ) );
add_action( 'footer14-js',  	array('block_footer14', 'js' ) );

class block_footer14 {
