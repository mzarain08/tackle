...
class block_listings4 {
	...
	?><section class="<?php echo $settings['section_class']." ".$settings['section_bg']." ".$settings['section_padding']." ".$settings['section_divider']; ?>" id="listings4<?php echo $randomID; ?>">
   <div class="container">
   <div class="row"> 
...
#listings4<?php echo $randomID; ?> .card-ppt-search { margin-bottom:0px !important; }
