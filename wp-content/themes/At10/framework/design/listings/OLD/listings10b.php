...
add_filter( 'ppt_blocks_args',  	array('block_listings10b',  'data') );
add_action( 'listings10b',  	array('block_listings10b', 'output' ) );
add_action( 'listings10b-css',  array('block_listings10b', 'css' ) );
add_action( 'listings10b-js',  	array('block_listings10b', 'js' ) );

class block_listings10b {
	...
	public static function data($a){ global $CORE;  
		...
		$a['listings10b'] = array(
			"name" 	=> "Style 10 - Search Results + Advertising",
			"image"	=> "listings10b.jpg",
			"cat"	=> "listings",
			"desc" 	=> "",
			"order" => 9, 
		...
		$settings = $CORE->LAYOUT("get_block_settings_defaults", array("listings10b", "listings", $settings ) );
