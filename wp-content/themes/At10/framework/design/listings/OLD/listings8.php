...
class block_listings8 {
   ...
   <div class="row">
	...
	echo do_shortcode('[LISTINGS dataonly=1 nav=0 custom="popular" show=4  card_class="col-12 col-sm-12" ]');  ?>  
    </div>
    <div class="col-12 col-md-6 col-lg-4">
    ...
    <?php echo do_shortcode('[LISTINGS dataonly=1 nav=0 custom="new" show=4  card_class="col-12 col-sm-12" ]');  ?>  
    </div>        
