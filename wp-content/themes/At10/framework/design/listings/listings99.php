...
add_filter( 'ppt_blocks_args', 	array('block_listings99',  'data') );
add_action( 'listings99',  		array('block_listings99', 'output' ) );
add_action( 'listings99-css',  		array('block_listings99', 'css' ) );
add_action( 'listings99-js',  		array('block_listings99', 'js' ) );

class block_listings99 {
...
<?php
		...
		ob_end_clean();
echo str_replace("%data%", $data,ppt_theme_block_output($output, $df, array("listings", "listings99")));
