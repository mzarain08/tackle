...
add_filter( 'ppt_blocks_args', 	array('block_listings100',  'data') );
add_action( 'listings100',  		array('block_listings100', 'output' ) );
add_action( 'listings100-css',  		array('block_listings100', 'css' ) );
add_action( 'listings100-js',  		array('block_listings100', 'js' ) );

class block_listings100 {
	...
	public static function data($a){ global $CORE; 
		...
		// 2. HOME DESIGNS		
		 	...
		 	$settings =   $CORE->LAYOUT("get_block_settings_defaults_new", array("listings", "listings100"  ) );
...
<?php
		...
		ob_end_clean();
echo str_replace("%data%", $data,ppt_theme_block_output($output, $df, array("listings", "listings100")));
