...
add_filter( 'ppt_blocks_args',  array('block_hero104',  'data') );
add_action( 'hero104',  			array('block_hero104', 'output' ) );
add_action( 'hero104-css',  		array('block_hero104', 'css' ) );
add_action( 'hero104-js',  		array('block_hero104', 'js' ) );
	...
	public static function data($a){ 
		...
		return $a;
		 ...
		 $cc = array(
		 	...
		 	"image1" => DEMO_IMG_PATH."icons/2.png",
...
ob_end_clean();
echo ppt_theme_block_output($output, $df, array("hero", "hero104"));
