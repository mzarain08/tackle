...
add_filter( 'ppt_blocks_args',  array('block_hero107',  'data') );
add_action( 'hero107',  			array('block_hero107', 'output' ) );
add_action( 'hero107-css',  		array('block_hero107', 'css' ) );
add_action( 'hero107-js',  		array('block_hero107', 'js' ) );
	...
	public static function data($a){ 
		...
		return $a;
		 ...
		 $cc = array(
		 	...
		 	"image1" => DEMO_IMG_PATH."icons/6.png",
			...
			"subtitle_color" => "#457cb3",
				
			
			"title" => "Amazing {Headline}",
			"title_underline" => 2,
			"title_underline_color" => "#457cb3",			
...
ob_end_clean();
echo ppt_theme_block_output($output, $df, array("hero", "hero107"));
