...
add_filter( 'ppt_blocks_args',  array('block_hero111',  'data') );
add_action( 'hero111',  			array('block_hero111', 'output' ) );
add_action( 'hero111-css',  		array('block_hero111', 'css' ) );
add_action( 'hero111-js',  		array('block_hero111', 'js' ) );
	...
	public static function data($a){ 
		...
		return $a;
		 ...
		 $cc = array(
		 	...
		 	"image1" => DEMO_IMG_PATH."icons/7.png",
		...
		// 2. HOME DESIGNS		
		 	...
		 	$settings =  $CORE->LAYOUT("get_block_settings_defaults_new", array("hero", "hero111" ) );
		 	foreach($df as $h => $j){
...
ob_end_clean();
echo ppt_theme_block_output($output, $df, array("hero", "hero111"));
