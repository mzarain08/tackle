...
add_filter( 'ppt_blocks_args',  array('block_hero112',  'data') );
add_action( 'hero112',  			array('block_hero112', 'output' ) );
add_action( 'hero112-css',  		array('block_hero112', 'css' ) );
add_action( 'hero112-js',  		array('block_hero112', 'js' ) );
	...
	public static function data($a){ 
		...
		return $a;
		 ...
		 $cc = array(
		 	...
		 	"image1" => DEMO_IMG_PATH."icons/12.png",
		...
		// 2. HOME DESIGNS		
		 	...
		 	$settings =  $CORE->LAYOUT("get_block_settings_defaults_new", array("hero", "hero112" ) );
...
ob_end_clean();
echo ppt_theme_block_output($output, $df, array("hero", "hero112"));
