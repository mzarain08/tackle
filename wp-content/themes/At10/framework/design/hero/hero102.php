...
add_filter( 'ppt_blocks_args',  array('block_hero102',  'data') );
add_action( 'hero102',  			array('block_hero102', 'output' ) );
add_action( 'hero102-css',  		array('block_hero102', 'css' ) );
add_action( 'hero102-js',  		array('block_hero102', 'js' ) );
	...
	public static function data($a){ 
		...
		return $a;
		 ...
		 $cc = array(
		 	...
		 	"image1" => DEMO_IMG_PATH."icons/4.png",
...
ob_end_clean();
echo ppt_theme_block_output($output, $df, array("hero", "hero102"));
