...
<div class="d-flex justify-content-between">
      <a class="navbar-brand" href="<?php echo home_url(); ?><?php if(defined('WLT_DEMOMODE')){ ?>/?reset=1<?php } ?>"><?php echo $CORE->LAYOUT("get_logo","dark");  ?> </a>
...
<?php if($settings['extra_type'] == "icons"){ ?>
          ...
          <?php if(!$userdata->ID){ ?>
            ...
            <img class="rounded-circle img-fluid lazt" data-src="<?php echo CDN_PATH; ?>images/avatar/none.png" alt="user" style="max-width:50px;"> 
            </a>
            <?php }else{ ?>
