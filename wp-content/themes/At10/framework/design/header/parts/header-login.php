...
<ul class="list-inline mb-0 small-list">
  <?php if(!$userdata->ID){ ?>
  <li class="list-inline-item hide-mobile"> <a <?php if(_ppt(array("user","wplogin")) == "1"){ ?> href="<?php echo wploginlink(); ?>" <?php }else{ ?>href="javascript:void(0);" onclick="processLogin();"<?php } ?>> <?php echo __("Sign In","premiumpress"); ?></a> </li>
