...
<nav class="elementor_mainmenu submenu-icon py-0 navbar-bottom navbar navbar-expand-lg navbar-dark d-none d-lg-block bg-dark border-top py-2 <?php if(!isset($GLOBALS['flag-home'])){ ?>border-bottom<?php } ?>">
  <div class="container">
