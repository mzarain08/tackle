...
_ppt_template( 'framework/design/header/parts/header-topmenu' ); ?>
   ...
   <nav class="elementor_mainmenu navbar navbar-light navbar-expand-lg">
      <div class="container"> 
       ...
       <div class="mx-auto text-center">
     	...
     	<div class="w-100 d-flex ml-lg-auto d-none d-md-block-inline text-center">
     
        <div class="d-lg-flex align-items-center ml-lg-auto  w-100">  <?php _ppt_template( 'framework/design/header/parts/header-button' ); ?> <div> 
  ...
  <nav class="elementor_mainmenu  menu-bold navbar-bottom navbar navbar-expand-lg navbar-light py-2 d-none d-md-block border-top border-bottom">
      <div class="container">
