	...
	public static function data($a){ global $CORE;
		...
		$a['testimonials1'] = array(
			...
			"defaults" => array(
					...
					"subtitle"			=> "Customer satisfaction is our number one goal.",					
					"desc" 				=> "",
		...
		if(is_array($new_settings)){
			...
			$default_data = $CORE->LAYOUT("get_block_defaults", "testimonials1");
   ...
   <?php if($settings['title_show'] == "yes"){ ?>
      ...
      <?php } ?>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-6 col-md-3 <?php if($i == 3){ echo "hide-mobile"; } ?>">
                    <div class="testmonial-1 bg-white shadow-sm rounded-lg">
                        ...
                        <div class="testmonial-3-author text-dark">
                            <h6 class="text-700"><?php if(isset($settings['author_name'.$i]) && strlen($settings['author_name'.$i]) > 1 ){ echo $settings['author_name'.$i]; }else{ ?>John Doe<?php } ?></h6>
                            <p class="opacity-8"><?php if(isset($settings['author_job'.$i]) && strlen($settings['author_job'.$i]) > 1 ){ echo $settings['author_job'.$i]; }else{ ?>PremiumPress<?php } ?></p>
                        </div>
                    </div>
                </div>
