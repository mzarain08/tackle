  ...
  <div class="container">
    <div class="row">
      <div class="col-12">
        ...
        <div class="card">
        <div class="card-body">
        <div  class="owl-carousel owl-theme"  data-1000="5" data-600="3"> 
        ...
        <div class="text-center border-0 card-coupon mb-0">
		  <?php /************ MIAN IMAGE ***/ ?>
          ...
          <?php /***************** */ ?>
          <div class="card-body  p-0 py-2 text-center small text-uppercase font-weight-bold opacity-5 link-dark"><a href="<?php echo $link; ?>">
           <?php 
