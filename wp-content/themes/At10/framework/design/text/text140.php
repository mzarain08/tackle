...
add_filter( 'ppt_blocks_args', 	array('block_text140',  'data') );
add_action( 'text140',  		array('block_text140', 'output' ) );
add_action( 'text140-css',  	array('block_text140', 'css' ) );
add_action( 'text140-js',  	array('block_text140', 'js' ) );
...
<?php
		...
		ob_end_clean();
echo ppt_theme_block_output($output, $text_settings, array("text", "text140") );
