...
add_filter( 'ppt_blocks_args', 	array('block_text125',  'data') );
add_action( 'text125',  		array('block_text125', 'output' ) );
add_action( 'text125-css',  	array('block_text125', 'css' ) );
add_action( 'text125-js',  	array('block_text125', 'js' ) );
...
class block_text125 {
	...
	$layout = array(
		...
		1 => "col-sm-6 col-md-6 col-lg-3",
		2 => "col-sm-6 col-md-6 col-lg-4",
		3 => "col-sm-6 col-md-6 col-lg-5",
		4 => "col-sm-6 col-md-6 col-lg-5",
		5 => "col-sm-6 col-md-6 col-lg-4",
		6 => "col-sm-6 col-md-6 col-lg-3",
		6 => "col-sm-6 col-md-6 col-lg-3",
  ...
  <div class="container">
    ...
    <?php $i=1; foreach($data as $cat){ ?>
         <div class="mb-4 <?php echo $layout[$i]; ?>">
            <div class="overflow-hidden text125-card style3 <?php echo $cat['css']; ?>">
...
ob_end_clean();
echo ppt_theme_block_output($output, $text_settings, array("text", "text125"));
...
.text125-card img{transition:all linear .25s}
.text125-card{background-color:#fff;box-shadow:0 0 25px rgba(0,0,0,.1);background-position:center;overflow:hidden;position:relative; transition:all linear .25s; width: 100%; border-radius: 10px; height:320px; min-width:200px;  }
.text125-card h4{ z-index: 2; position:absolute;font-size:25px;font-weight:700;color:#fff;transition:all linear .25s;text-shadow:0 0 20px rgba(0,0,0,.5)}
.text125-card h4 strong { font-weight:600; } 
 
.text125-card.style3 h4{left:0;bottom:20px;text-align:center;width:100%;font-size:30px;color:#fff; line-height:40px; }
.text125-card.style3 h4 span{font-size:13px;display:block}.text125-card.style3:hover img{filter:grayscale(100%)}
.text125-card.style3:hover h4{bottom:30px}   
