...
add_filter( 'ppt_blocks_args', 	array('block_text175',  'data') );
add_action( 'text175',  		array('block_text175', 'output' ) );
add_action( 'text175-css',  	array('block_text175', 'css' ) );
add_action( 'text175-js',  	array('block_text175', 'js' ) );
...
<?php
		...
		ob_end_clean();
echo ppt_theme_block_output($output, $text_settings, array("text", "text175"));
