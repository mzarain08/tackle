...
add_filter( 'ppt_blocks_args', 	array('block_text143',  'data') );
add_action( 'text143',  		array('block_text143', 'output' ) );
add_action( 'text143-css',  	array('block_text143', 'css' ) );
add_action( 'text143-js',  	array('block_text143', 'js' ) );
...
<div class="row no-gutters">
  ...
  <div class="col-lg-6">
    <div class="d-flex d-block flex-row">
      ...
      <div>
      <blockquote class="p-4 bg-light rounded-lg text-dark">
...
<?php
		...
		ob_end_clean();
echo ppt_theme_block_output($output, $text_settings, array("text", "text143") );
