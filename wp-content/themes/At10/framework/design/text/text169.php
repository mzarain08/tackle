...
add_filter( 'ppt_blocks_args', 	array('block_text169',  'data') );
add_action( 'text169',  		array('block_text169', 'output' ) );
add_action( 'text169-css',  	array('block_text169', 'css' ) );
add_action( 'text169-js',  	array('block_text169', 'js' ) );
...
<?php
		...
		ob_end_clean();
echo ppt_theme_block_output($output, $text_settings, array("text", "text169"));
