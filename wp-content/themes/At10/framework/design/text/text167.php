...
add_filter( 'ppt_blocks_args', 	array('block_text167',  'data') );
add_action( 'text167',  		array('block_text167', 'output' ) );
add_action( 'text167-css',  	array('block_text167', 'css' ) );
add_action( 'text167-js',  	array('block_text167', 'js' ) );
...
<section class="section-60 bg-white">
  <div class="container">
	...
	$i=1; while($i < 9){ ?>
      <div class="col-lg-3 text-lg-center mb-4">
        <div class="px-lg-5">
          <div class="row">
...
<?php
		...
		ob_end_clean();
echo ppt_theme_block_output($output, $text_settings, array("text", "text167"));
