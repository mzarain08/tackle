...
add_filter( 'ppt_blocks_args', 	array('block_text18a',  'data') );
add_action( 'text18a',  		array('block_text18a', 'output' ) );
add_action( 'text18a-css',  	array('block_text18a', 'css' ) );
add_action( 'text18a-js',  	array('block_text18a', 'js' ) );
...
class block_text18a {
	...
	public static function data($a){  global $CORE;
		...
		"text_image1" => DEMO_IMG_PATH."_bg/text1_800x600b.jpg",
		...
		$settings = $CORE->LAYOUT("get_block_settings_defaults", array("text18a", "text", $settings ) );
...
<div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-5 order-first order-lg-last">
                            <div class="block-text18a-image rounded-lg" style="background-image: url(<?php echo $settings['text_image1']; ?>);"></div>
                        </div>
                    </div>
                </div>
