...
add_filter( 'ppt_blocks_args', 	array('block_headline4',  'data') );
add_action( 'headline4',  		array('block_headline4', 'output' ) );
add_action( 'headline4-css',  	array('block_headline4', 'css' ) );
add_action( 'headline4-js',  	array('block_headline4', 'js' ) );

class block_headline4 {
	...
	public static function data($a){  global $CORE;
		...
		$cc = array(
			...
			"title_underline" 		=> 4, // number of underline style			
...
ob_end_clean();
echo  ppt_theme_block_output($output, $df, array("headline", "headline4"));
