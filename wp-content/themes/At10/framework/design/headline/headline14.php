...
add_filter( 'ppt_blocks_args', 	array('block_headline14',  'data') );
add_action( 'headline14',  		array('block_headline14', 'output' ) );
add_action( 'headline14-css',  	array('block_headline14', 'css' ) );
add_action( 'headline14-js',  	array('block_headline14', 'js' ) );

class block_headline14 {
	...
	public static function data($a){  global $CORE;
		...
		$cc = array(
			...
			"title_animated" 		=> "ppt-animate-wobble", // typed
  ...
  <?php } ?>
   ...
   <h2 data-ppt-title>Wobble [One,Two,Three,Four] Headline</h2>
...
ob_end_clean();
echo  ppt_theme_block_output($output, $df, array("headline", "headline14"));
