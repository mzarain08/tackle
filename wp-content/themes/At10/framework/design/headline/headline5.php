...
add_filter( 'ppt_blocks_args', 	array('block_headline5',  'data') );
add_action( 'headline5',  		array('block_headline5', 'output' ) );
add_action( 'headline5-css',  	array('block_headline5', 'css' ) );
add_action( 'headline5-js',  	array('block_headline5', 'js' ) );

class block_headline5 {
	...
	public static function data($a){  global $CORE;
		...
		$cc = array(
			...
			"title_underline" 		=> 5, // number of underline style			
...
ob_end_clean();
echo  ppt_theme_block_output($output, $df, array("headline", "headline5"));
