...
add_filter( 'ppt_blocks_args', 	array('block_headline12',  'data') );
add_action( 'headline12',  		array('block_headline12', 'output' ) );
add_action( 'headline12-css',  	array('block_headline12', 'css' ) );
add_action( 'headline12-js',  	array('block_headline12', 'js' ) );

class block_headline12 {
  ...
  <?php } ?>
   ...
   <h2 data-ppt-title>Zoom [One,Two,Three,Four] Headline</h2>
...
ob_end_clean();
echo  ppt_theme_block_output($output, $df, array("headline", "headline12"));
