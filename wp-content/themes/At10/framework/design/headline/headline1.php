...
add_filter( 'ppt_blocks_args', 	array('block_headline1',  'data') );
add_action( 'headline1',  		array('block_headline1', 'output' ) );
add_action( 'headline1-css',  	array('block_headline1', 'css' ) );
add_action( 'headline1-js',  	array('block_headline1', 'js' ) );

class block_headline1 {
	...
	public static function data($a){  global $CORE;
		...
		// 2. HOME DESIGNS		
		 	...
		 	$settings =  $CORE->LAYOUT("get_block_settings_defaults_new", array("headline", "headline1" ) );
...
ob_end_clean();
echo  ppt_theme_block_output($output, $df, array("headline", "headline1"));
