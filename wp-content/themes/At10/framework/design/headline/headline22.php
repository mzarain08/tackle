...
add_filter( 'ppt_blocks_args', 	array('block_headline22',  'data') );
add_action( 'headline22',  		array('block_headline22', 'output' ) );
add_action( 'headline22-css',  	array('block_headline22', 'css' ) );
add_action( 'headline22-js',  	array('block_headline22', 'js' ) );

class block_headline22 {
  ...
  <?php } ?>
   ...
   <h1 data-ppt-title>PremiumPress Themes</h1>
...
ob_end_clean();
echo  ppt_theme_block_output($output, $df, array("headline", "headline22"));
