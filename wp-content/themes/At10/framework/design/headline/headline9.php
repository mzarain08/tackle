...
add_filter( 'ppt_blocks_args', 	array('block_headline9',  'data') );
add_action( 'headline9',  		array('block_headline9', 'output' ) );
add_action( 'headline9-css',  	array('block_headline9', 'css' ) );
add_action( 'headline9-js',  	array('block_headline9', 'js' ) );

class block_headline9 {
	...
	public static function data($a){  global $CORE;
		...
		$cc = array(
			...
			"title_underline" 		=> 9, // number of underline style			
...
ob_end_clean();
echo  ppt_theme_block_output($output, $df, array("headline", "headline9"));
