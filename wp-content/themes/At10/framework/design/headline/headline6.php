...
add_filter( 'ppt_blocks_args', 	array('block_headline6',  'data') );
add_action( 'headline6',  		array('block_headline6', 'output' ) );
add_action( 'headline6-css',  	array('block_headline6', 'css' ) );
add_action( 'headline6-js',  	array('block_headline6', 'js' ) );

class block_headline6 {
	...
	public static function data($a){  global $CORE;
		...
		$cc = array(
			...
			"title_underline" 		=> 6, // number of underline style			
...
ob_end_clean();
echo  ppt_theme_block_output($output, $df, array("headline", "headline6"));
