...
add_filter( 'ppt_blocks_args', 	array('block_headline13',  'data') );
add_action( 'headline13',  		array('block_headline13', 'output' ) );
add_action( 'headline13-css',  	array('block_headline13', 'css' ) );
add_action( 'headline13-js',  	array('block_headline13', 'js' ) );

class block_headline13 {
	...
	public static function data($a){  global $CORE;
		...
		$cc = array(
			...
			"title_animated" 		=> "ppt-animate-rubberBand", // typed
  ...
  <?php } ?>
   ...
   <h2 data-ppt-title>RubberBand [One,Two,Three,Four] Headline</h2>
...
ob_end_clean();
echo  ppt_theme_block_output($output, $df, array("headline", "headline13"));
