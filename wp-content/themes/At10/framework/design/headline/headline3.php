...
add_filter( 'ppt_blocks_args', 	array('block_headline3',  'data') );
add_action( 'headline3',  		array('block_headline3', 'output' ) );
add_action( 'headline3-css',  	array('block_headline3', 'css' ) );
add_action( 'headline3-js',  	array('block_headline3', 'js' ) );

class block_headline3 {
...
ob_end_clean();
echo  ppt_theme_block_output($output, $df, array("headline", "headline3"));
