...
add_filter( 'ppt_blocks_args', 	array('block_headline8',  'data') );
add_action( 'headline8',  		array('block_headline8', 'output' ) );
add_action( 'headline8-css',  	array('block_headline8', 'css' ) );
add_action( 'headline8-js',  	array('block_headline8', 'js' ) );

class block_headline8 {
	...
	public static function data($a){  global $CORE;
		...
		$cc = array(
			...
			"title_underline" 		=> 8, // number of underline style			
...
ob_end_clean();
echo  ppt_theme_block_output($output, $df, array("headline", "headline8"));
