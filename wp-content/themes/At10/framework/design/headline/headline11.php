...
add_filter( 'ppt_blocks_args', 	array('block_headline11',  'data') );
add_action( 'headline11',  		array('block_headline11', 'output' ) );
add_action( 'headline11-css',  	array('block_headline11', 'css' ) );
add_action( 'headline11-js',  	array('block_headline11', 'js' ) );

class block_headline11 {
	...
	public static function data($a){  global $CORE;
		...
		$cc = array(
			...
			"title_animated" 		=> "ppt-animate-fade-in ", // typed
  ...
  <?php } ?>
   ...
   <h2 data-ppt-title>Fade [One,Two,Three,Four] Headline</h2>
...
ob_end_clean();
echo  ppt_theme_block_output($output, $df, array("headline", "headline11"));
