...
class block_category3 {
	...
	public static function data($a){ 
		...
		// 2. HOME DESIGNS		
		 	...
		 	$settings =  $CORE->LAYOUT("get_block_settings_defaults_new", array("category", "category3" ) );
		 	foreach($df as $h => $j){
      ...
      <div class="col-md-12 mb-4">
        <div class="text-600 d-md-flex justify-content-between align-items-center">
          <div>
            ...
            <div class="my-3" data-ppt-desc><?php echo $df['desc']; ?> </div>
          </div>
          <div>
...
echo ppt_theme_block_output($output, $df, array("category", "category3"));
