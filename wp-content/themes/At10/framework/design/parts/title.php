...
if($settings['title_show'] == "yes"){
	...
	switch($settings['title_pos']){
		...
		case "right": {
		$txtdir = "text-md-right";
		} break;
		case "center": {
		$txtdir = "text-md-center";
		} break;	
	}
	...
	switch($settings['title_style']){
		  ...
		  { 
            ...
            <?php } ?>
             ...
             <hr style="width:50px; height:3px;margin:0px;" class="bg-primary my-4  <?php if($settings['title_pos'] == "center"){ ?>mx-auto<?php } ?>" />
            ...
            <div class="<?php echo $txtdir; ?>">
               ...
               <?php if(strlen($settings['btn_icon']) > 1){ ?>
			<i class="<?php echo $settings['btn_icon']; ?> fa-3x mb-4 my-4 my-md-0 mb-md-4"></i>
            <?php }else{ ?>
            <i class="fal fa-layer-group fa-3x my-4 my-md-0 mb-md-4"></i>
            <?php } ?>
