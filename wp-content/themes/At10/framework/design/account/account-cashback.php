          ...
          <div class="row">
            <div class="col-md-12">
             ...
             <label class="small font-weight-bold"><?php echo __("Which coupon did you use?","premiumpress"); ?></label>
              ...
              <div class="input-group"> <span class="input-group-prepend input-group-text rounded-0">#</span>
              ...
              <div class="input-group"> <span class="input-group-prepend input-group-text rounded-0"><?php if(strpos( _ppt(array('currency','symbol')), "fa") === false){ echo hook_currency_symbol('');  }else{ echo '<i class="'._ppt(array('currency','symbol')).'"></i>'; } ?></span>
