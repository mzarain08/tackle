...
<div class="card card-job-<?php echo $offer_status; ?> mb-3" id="card-jobid<?php echo $p->ID; ?>">
  ...
  <div id="collapse<?php echo $p->ID; ?>" class="collapse rounded-0" aria-labelledby="heading<?php echo $p->ID; ?>" data-parent="#accordion">
    <div class="card-body">
      <div class="container mb-4 px-0">
        ...
        <?php } ?>
        <?php if($job_buyer_id == $userdata->ID){ ?>
        <div class="stepbox hide-mobile row mb-5 mt-4 p-0 w-100">
        ...
        <?php }else{ ?>
        <div class="stepbox hide-mobile row mb-5 mt-4">
          <div class="col-4 stepbox-step step1 active">
            ...
            <ul class="payment-right pl-0">
              ...
              <li>
                ...
                <li  class="border-0">
                                    ...
                                    <div class="right">
                                       <span>
                                       <a href="<?php echo home_url(); ?>/?invoiceid=<?php echo $payment_id; ?>" target='_blank' style='text-decoration:underline;'> 
...
<div ppt-icon-32 data-ppt-icon-size="32" class="float-left mr-4 ml-2 pb-3 mt-2 hide-mobile">
    ...
    <div><?php echo __("Feedback left on","premiumpress"); ?> <?php echo hook_date($feedback_date); ?></div>
