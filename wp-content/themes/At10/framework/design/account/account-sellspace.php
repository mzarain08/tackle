...
<?php if(empty($campaigns->posts)){   ?>
 <div class="col-md-12 text-center">
    ...
    <i class="fal fa-ad fa-4x mb-4 text-light"></i>
    
    
    <h4> <?php echo __("No advertising purchased","premiumpress") ?></h4>
    
     <a href="<?php echo _ppt(array('links','sellspace')); ?>" class="btn btn-md shadow-sm btn-system mt-4"><?php echo __("Buy Ads","premiumpress"); ?></a>
                        ...
                        <?php } ?>
                          ...
                          <div class="form-group">        
                              <label><?php echo __("Banner Link","premiumpress"); ?></label>
                                 ...
                                 <button class="btn rounded-0 btn-primary rounded btn-md mt-3"><?php echo __("Save Changes","premiumpress"); ?></button>   
...
<i class="fal fa-clock mr-2"></i> <?php  echo $e['days'].__("left","premiumpress");   ?>
</div>
<?php } ?>
            ...
            <div class="bg-light p-3 mb-4">
               <form action="" method="post" class="p-3 bg-light" enctype="multipart/form-data"  id="bupload">
                 <input type="hidden" name="showtab" value="sellspace" />
                  ...
                  <div>
                  <button type="submit" class="btn btn-primary mt-4 rounded" id="savemb" style="display:none;"><?php echo __("Save Banner","premiumpress"); ?></button> 
                  </div>  
               </form>
            </div>
