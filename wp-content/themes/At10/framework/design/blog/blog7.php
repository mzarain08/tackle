...
add_filter( 'ppt_blocks_args', 	array('block_blog7',  'data') );
add_action( 'blog7',  		array('block_blog7', 'output' ) );
add_action( 'blog7-css',  	array('block_blog7', 'css' ) );
add_action( 'blog7-js',  	array('block_blog7', 'js' ) );
...
echo ppt_theme_block_output($output, $blog_settings, array("blog", "blog7"));
