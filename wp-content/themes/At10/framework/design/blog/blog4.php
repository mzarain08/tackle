...
add_filter( 'ppt_blocks_args', 	array('block_blog4',  'data') );
add_action( 'blog4',  		array('block_blog4', 'output' ) );
add_action( 'blog4-css',  	array('block_blog4', 'css' ) );
add_action( 'blog4-js',  	array('block_blog4', 'js' ) );
    ...
    ?>
      <div class="col-md-4 mb-4">
        <article>
          ...
          <div class="opacity-5 fs-sm text-dark">
...
echo ppt_theme_block_output($output, $blog_settings, array("blog", "blog4"));
