...
class Widget_PremiumPress_New_Text extends \Elementor\Widget_Base {
...
$blocks = ppt_theme_blocks_elementor("text");
...
///////////////////////////////////////////////////////////////////////////////////////
		...
		$this->add_control(
				...
				[
					...
					'options' => _ppt_elementor_get_blocks("text","ppt-text"),
					'default' => 'text100',
				]
		);
		...
		$this->add_control(
			...
			[
				...
				'raw' => '<div id="ppt_elementor_designs">'.ppt_elementor_designs("text").'</div>',
			]
		);	
	...
	protected function render() { global $text_settings;
		...
		// ADDON 
		$blocks = ppt_theme_blocks_elementor("text", 1);	
