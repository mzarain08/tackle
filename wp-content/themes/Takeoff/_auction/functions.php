                ...
                case "buynow": {
                    ...
                    if( $qty > 0 ){
                        ...
                        if(isset($buynowdata[$userdata->ID])){
                            $buynowdata[$userdata->ID] = array("price" => $bin_price, "date" => current_time( 'mysql' ), "qty" => $buynowdata[$userdata->ID]['qty'] + 1, "username" =>  $CORE->USER("get_display_name", $userdata->ID) );
                        }else{
                            $buynowdata[$userdata->ID] = array("price" => $bin_price, "date" => current_time( 'mysql' ), "qty" => 1, "username" =>  $CORE->USER("get_display_name", $userdata->ID) );
                        }
                        ...
                        update_post_meta($postid,'qty-sold-buynow', get_post_meta($postid,'qty-sold-buynow', true) + 1 );
